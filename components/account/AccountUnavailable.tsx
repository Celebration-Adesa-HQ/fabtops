  ...
  return (
    <main className="min-h-screen bg-brand-secondary px-6 pb-24 pt-40">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        <p className="mb-5 text-[10px] font-black uppercase tracking-[0.45em] text-brand-dark/75">Customer Accounts</p>
        <h1 className="font-heading text-5xl uppercase tracking-tight text-brand-dark md:text-7xl">Returning Soon</h1>
        <p className="mt-8 max-w-lg text-sm leading-7 text-brand-dark/85">
        ...
        <Link href="/shop" className="mt-10 bg-brand-dark px-10 py-5 text-[10px] font-black uppercase tracking-[0.35em] text-brand-light transition-colors hover:bg-brand-primary hover:text-brand-dark">
          Continue Shopping
        </Link>
      </div>
    </main>
