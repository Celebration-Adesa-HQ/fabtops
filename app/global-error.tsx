    ...
    <html lang="en" className={`${playfair.variable} ${raleway.variable}`}>
      <body className="min-h-screen bg-brand-light flex items-center justify-center p-6">
        <div className="text-center max-w-xl">
          ...
          <p className="text-brand-dark/60 font-body mb-10 text-sm uppercase tracking-widest leading-loose">
            A fundamental error has occurred. We are working to restore the digital flagship experience.
          </p>
          <button
            onClick={() => reset()}
            className="bg-brand-dark text-white px-10 py-6 text-[10px] uppercase tracking-[0.4em] font-bold hover:bg-brand-primary transition-all"
          >
            Refresh Platform
          </button>
        </div>
