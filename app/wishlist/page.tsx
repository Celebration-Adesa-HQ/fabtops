...
import { ShoppingBag, Heart, ChevronRight, ArrowRight, Lock, Sparkles } from 'lucide-react';
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-block px-10 md:px-12 py-4 md:py-5 bg-brand-dark text-white text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-black hover:bg-brand-primary transition-all duration-500 shadow-xl shadow-brand-dark/5"
            >
              Sign In to View
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-brand-light pt-24 md:pt-32 pb-40 px-5 md:px-8 lg:px-12 xl:px-24">
      <div className="max-w-[1440px] mx-auto">
            ...
            {favorites.map((product, i) => (
              ...
              >
                <div className="block relative">
                  ...
                  <div className="relative aspect-[3/4] mb-8 overflow-hidden bg-white border border-brand-dark/5 group-hover:border-brand-primary/20 transition-all duration-700 shadow-sm hover:shadow-2xl hover:shadow-brand-primary/5">
        ...
        >
          ...
          <Link
            href="/shop"
            className="px-12 py-6 bg-brand-dark text-white text-[10px] uppercase tracking-[0.5em] font-black hover:bg-brand-primary transition-all rounded-full shadow-2xl shadow-brand-dark/5"
          >
            Explore Catalog
          </Link>
        </motion.div>
