  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-brand-light px-6 py-32 text-center">
      <div className="max-w-xl">
        ...
        <p className="mt-8 text-[10px] font-black uppercase tracking-[0.45em] text-brand-dark/75">
          Payment Incomplete
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link href="/checkout" className="inline-block bg-brand-dark px-10 py-5 text-[10px] font-black uppercase tracking-[0.35em] text-brand-light hover:bg-brand-primary hover:text-brand-dark">
            Try Again
          </Link>
          <Link href="/cart" className="inline-block border border-brand-dark/10 px-10 py-5 text-[10px] font-black uppercase tracking-[0.35em] text-brand-dark hover:border-brand-primary hover:text-brand-dark">
            Edit Cart
          </Link>
        </div>
      </div>
